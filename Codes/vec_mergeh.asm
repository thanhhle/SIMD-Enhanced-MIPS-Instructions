...
#			a Vector Merge High instruction where the syntax is vec_merge d, a, b. Vector a, b, and d consist of
#			eight 8-bit elements. When the instruction is execute, the even elements of the result vector d are
#			obtained left-to-right from the high elements of vector a. The odd elements of the result are obtained
#			left-to-right from the high elements of vector b.
#
...
loop:		and	$t1, $s0, $t0		# load 8 bits of $s0 (a higher element of a) into $t1
		and	$t2, $s2, $t0		# load 8 bits in corresponding section of $s2 (a higher element of b) into $t
